from moeda import aumentar, diminuir, dobrar, metade
from time import sleep

print('Olá, Eu me chamo Josh, seu calculador vitural.')
...
while True:
    ...
    while True:
        ...
        if escolha == 1:
            ...
            print(f'Aumentando 10% seu valor fica {valor:.2f}')
            break

        elif escolha == 2:
            valor = diminuir(valor)
            print(f'Diminuindo 10% seu valor fica {valor:.2f}')
            break
            

        elif escolha == 3:
            valor = dobrar(valor)
            print(f'O dobro fica {valor:.2f}')
            break
        elif escolha == 4:
            valor = metade(valor)
            print(f'A metade fica {valor:.2f}')
            break
